...
This runs containers on emulators with interpreter approach so the execution can be slower than the emscripten example which uses QEMU with JIT(TCG) enabled.
