...
# container2wasm: OCI Container to WASM converter

container2wasm is a container-to-wasm image converter that enables to run the container on WASM.

- Converts a [container](https://github.com/opencontainers/image-spec/) to WASM with emulation by Bochs (for x86_64 containers) and TinyEMU (for riscv64 containers).
