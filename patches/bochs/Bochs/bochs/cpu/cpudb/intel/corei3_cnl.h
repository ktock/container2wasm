...
#ifndef BX_CANNONLAKE_CPUID_DEFINITIONS_H
#define BX_CANNONLAKE_CPUID_DEFINITIONS_H

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

#include "cpu/cpuid.h"

class corei3_cnl_t : public bx_cpuid_t {
public:
  corei3_cnl_t(BX_CPU_C *cpu);
  virtual ~corei3_cnl_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "corei3_cnl_t"; }
...
extern bx_cpuid_t *create_corei3_cnl_cpuid(BX_CPU_C *cpu);
