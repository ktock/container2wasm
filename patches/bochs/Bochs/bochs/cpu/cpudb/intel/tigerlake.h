...
class tigerlake_t : public bx_cpuid_t {
public:
  tigerlake_t(BX_CPU_C *cpu);
  virtual ~tigerlake_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "tigerlake"; }
...
private:
  ...
  void get_std_cpuid_leaf_18(Bit32u subfunction, cpuid_function_t *leaf) const;
...
extern bx_cpuid_t *create_tigerlake_cpuid(BX_CPU_C *cpu);
