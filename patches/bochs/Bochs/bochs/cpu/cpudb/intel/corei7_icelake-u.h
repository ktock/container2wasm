...
class corei7_icelake_t : public bx_cpuid_t {
public:
  corei7_icelake_t(BX_CPU_C *cpu);
  virtual ~corei7_icelake_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "corei7_icelake_u"; }
