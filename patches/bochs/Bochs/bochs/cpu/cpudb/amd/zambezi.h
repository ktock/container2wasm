...
#ifndef BX_AMD_ZAMBEZI_CPUID_DEFINITIONS_H
#define BX_AMD_ZAMBEZI_CPUID_DEFINITIONS_H

#if BX_SUPPORT_X86_64 && BX_SUPPORT_AVX

#include "cpu/cpuid.h"

class zambezi_t : public bx_cpuid_t {
public:
  zambezi_t(BX_CPU_C *cpu);
  virtual ~zambezi_t() {}

  // return CPU name
  virtual const char *get_name(void) const { return "zambezi"; }
...
extern bx_cpuid_t *create_zambezi_cpuid(BX_CPU_C *cpu);
